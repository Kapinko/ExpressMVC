...
module.exports = (function () {
    ...
    function parse_url(target_url) {
        var p       = url.parse(target_url, true);
    ...
    oAuth.prototype = {
        ...
        'post': function (target_url, params, callback) {
            this.check_token.call(this, true);
        ...
        'sign': function (base_string, encoding) {
            ...
            if (this.signature_method === SIGNATURE_METHOD_HMAC_SHA1) {
            ...
            return hmac.digest(encoding || SIGNATURE_ENCODING_DEFAULT);
        },
        /**
        ...
        'getParameterString': function (query, params) {
            ...
            var string  = querystring.stringify(query) + 
                    '&' + querystring.stringify(this.oauth_params) +
